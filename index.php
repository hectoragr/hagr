	...
	<div id="content">
		...
		<div id="right_col">
			...
			<div class="item">
				...
				<div><span class="title"><?php echo $lang['email']; ?></span><br />
				<span class="subtitle"><a href="mailto:<?php echo($personal['email_address']); ?>"><?php echo($personal['email_address']); ?></a></span></div>
				<?php } ?>
				
				<?php if (isset($settings['social_media']) && $settings['social_media'] == true) { ?>
				<?php for($i=0; $i<count($social_media); $i++) { ?>
				<div><span class="title"><?php echo($social_media[$i][0]); ?><br />
				<span class="subtitle"><a href="<?php echo($social_media[$i][1]); ?>"><?php echo(substr($social_media[$i][1], strpos($social_media[$i][1], "://")+3)); ?></a></span></div>
				<?php } ?>
				<?php } ?>
			</div>
		</div>
